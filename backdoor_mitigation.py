...
# backdoor parameters
parser.add_argument('--poison_type', type=str, default='badnets', choices=['badnets', 'invisible', 'clb', 'trojannet',
                                                                           'semantic'],
...
def detect():
    ...
    if args.poison_type == 'badnets' or args.poison_type == 'invisible' or args.poison_type == 'clb':
        end2 = time.time()
